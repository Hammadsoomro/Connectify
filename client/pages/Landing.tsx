...
const testimonials = [
  {
    ...
    company: "Spotify",
    content:
      "Connectlify's API integration was seamless. We saw 40% improvement in customer engagement within the first month.",
    avatar:
  ...
  },
  {
    ...
    company: "Slack",
    content:
      "The real-time features and analytics dashboard have transformed how we communicate with our customers.",
    avatar:
  ...
  },
  {
    ...
    company: "StartupCore",
    content:
      "Best SMS platform for startups. Affordable, reliable, and scales with your business needs.",
    avatar:
  ...
  },
  {
    ...
    company: "RetailPro",
    content:
      "Customer support is outstanding. Implementation was smooth and we're seeing great ROI.",
    avatar:
...
const faqs = [
  {
    ...
    answer:
      "You can start sending messages within minutes. Simply sign up, verify your account, and you'll receive free credits to test our platform.",
  },
  {
    question: "Do you offer international SMS?",
    answer:
      "Yes, we support SMS delivery to 200+ countries worldwide with competitive rates and local phone numbers in 50+ countries.",
  },
  {
    question: "Is there a setup fee?",
    answer:
      "No setup fees, no hidden charges. You only pay for what you use with transparent, pay-as-you-go pricing.",
  },
  {
    question: "What support do you provide?",
    answer:
      "We offer 24/7 email support for all plans, priority support for Professional plans, and dedicated phone support for Enterprise customers.",
  },
  {
    question: "Can I integrate with my existing systems?",
    answer:
      "Absolutely! We provide RESTful APIs, webhooks, and SDKs for popular programming languages. Our team can help with custom integrations.",
  },
  {
    question: "Is my data secure?",
    answer:
      "Yes, we use enterprise-grade security with end-to-end encryption, SOC 2 Type II compliance, and GDPR compliance for data protection.",
  },
];
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10">
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-300 mb-12 leading-relaxed animate-fade-in-up delay-500">
                Send, receive, and manage SMS messages at scale with our
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
                Everything you need to build, scale, and optimize your SMS
        ...
        <section
          id="testimonials"
          className="py-20 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-slate-800 dark:to-slate-900"
        >
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-slate-800 dark:text-slate-100 mb-6">
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto mb-8">
                Choose the plan that fits your needs. No setup fees, no hidden
                charges.
              </p>
        ...
        >
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
                Everything you need to know about Connectlify. Can't find what
                you're looking for?
            ...
            <div className="max-w-4xl mx-auto">
              {faqs.map((faq, index) => (
                <Card
                  key={index}
                  className="mb-4 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-0 shadow-lg"
                >
                  <button
            ...
            <div className="grid md:grid-cols-4 gap-8 mb-12">
              <div>
                ...
                <p className="text-slate-400 leading-relaxed">
                  Transform your business communication with enterprise-grade
                  SMS messaging.
                </p>
              </div>
            ...
            <div className="border-t border-slate-800 pt-8">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <p className="text-slate-400 text-sm">
                  © 2025 Connectlify by Hammad Soomro. All rights reserved.
                </p>
