...
const features = [
  ...
  },
  {
    icon: Globe,
    title: "Global Reach",
    description: "Phone numbers available in 50+ countries with competitive pricing",
  ...
  },
  {
    ...
    description: "Bank-level encryption with compliance standards for businesses",
  ...
  },
  {
    ...
    description: "Access from web, mobile apps, and integrate with your existing tools",
...
const testimonials = [
  ...
  },
  {
    ...
    content: "The analytics and automation features helped us increase engagement by 300%.",
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-300 max-w-4xl mx-auto mb-12 leading-relaxed animate-fade-in-up delay-500">
              ...
              <span className="font-semibold text-blue-600 dark:text-blue-400">enterprise-grade SMS platform</span>.
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {heroStats.map((stat, index) => (
              <Card key={index} className="text-center p-6 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 animate-fade-in-up" style={{ animationDelay: `${index * 100 + 1100}ms` }}>
                ...
                <div className="text-3xl font-bold text-slate-800 dark:text-slate-100 mb-2">{stat.number}</div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20 max-w-7xl mx-auto">
          {/* Conversations Card */}
          <Card className="group hover:shadow-2xl transition-all duration-500 cursor-pointer border-0 shadow-xl bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm overflow-hidden transform hover:scale-105 animate-fade-in-up delay-1200" onClick={handleConversationsClick}>
            ...
            <CardContent>
              <p className="text-slate-600 dark:text-slate-300 mb-4">
                Access real-time SMS conversations with advanced features like typing indicators, read receipts, and smart contact management.
              </p>
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="font-bold text-yellow-600">&lt; 100ms</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          {/* Buy Numbers Card */}
          <Card className="group hover:shadow-2xl transition-all duration-500 cursor-pointer border-0 shadow-xl bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm overflow-hidden transform hover:scale-105 animate-fade-in-up delay-1300" onClick={() => navigate("/buy-numbers")}>
            ...
            <CardContent>
              <p className="text-slate-600 dark:text-slate-300 mb-4">
                Purchase premium phone numbers from 50+ countries with instant activation and full regulatory compliance.
              </p>
              <div className="space-y-3">
          ...
          {/* Pricing Card */}
          <Card className="group hover:shadow-2xl transition-all duration-500 cursor-pointer border-0 shadow-xl bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm overflow-hidden transform hover:scale-105 animate-fade-in-up delay-1400" onClick={() => navigate("/pricing")}>
            ...
            <CardContent>
              <p className="text-slate-600 dark:text-slate-300 mb-4">
                Choose from flexible pricing plans designed for businesses of all sizes. No hidden fees, no long-term contracts.
              </p>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
        ...
        <div className="mb-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              Advanced features designed for modern businesses that demand reliability, security, and performance.
            </p>
          </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className={`p-8 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-500 animate-fade-in-up`} style={{ animationDelay: `${index * 200 + 2000}ms` }}>
        ...
        <div className="text-center py-12 bg-slate-100/50 dark:bg-slate-800/50 rounded-3xl backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50">
          <div className="text-center mb-6">
            <span className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider">Advertisement</span>
          </div>
